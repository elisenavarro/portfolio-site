...
geosure = Project.create(title: 'GeoSure', description: 'Empowering individuals and communities to take control of their own well being. GeoSafeScores™ incorporate the most trusted safety, security, and health data available, with realtime safety score updates for over 65,000 locations (and counting) across the globe, right down to the neighborhood level.', image_gallery: 'geosure_background.png', tagline: 'Safety information everywhere.', site_url: 'https://geosureglobal.com/')
